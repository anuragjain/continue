...
const vscodeShortcuts: KeyboardShortcutProps[] = [
  ...
  },
  {
    ...
    windows: "⌃ L",
    description:
      "New Chat / New Chat With Selected Code / Close Jarvis Sidebar If Chat Already In Focus",
  },
  {
    mac: "⌘ ⌫",
    windows: "⌃ ⌫",
  ...
  },
  {
    ...
    windows: "⌃ ⇧ L",
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close Jarvis Sidebar If Chat Already In Focus",
  },
  {
    mac: "⌘ ⇧ R",
    windows: "⌃ ⇧ R",
